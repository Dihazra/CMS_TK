...
func (apiCfg *apiConfig) handlerCreateContent(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Create Content", "content", content.ID.String(), "Created content: "+content.Title)
...
func (apiCfg *apiConfig) handlerUpdateContent(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Update Content", "content", content.ID.String(), "Updated content: "+content.Title)
...
func (apiCfg *apiConfig) handlerSubmitToReview(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Submit Content To Review", "content", contentID.String(), "Submitted to review for plan date: "+params.PlanDate)
...
func (apiCfg *apiConfig) handlerReviewContent(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Review Content", "content", contentID.String(), "Reviewed content with status: "+params.Status)
...
func (apiCfg *apiConfig) handlerDeleteContent(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Delete Content", "content", contentID.String(), "Deleted content ID: "+contentID.String())
