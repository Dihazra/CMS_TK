...
func (apiCfg *apiConfig) handlerUpsertPlan(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Upsert Plan", "plan", plan.ID.String(), "Upserted plan for date: "+plan.PlanDate.Format("2006-01-02"))
...
func (apiCfg *apiConfig) handlerUpdatePlanStatus(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Update Plan Status", "plan", plan.ID.String(), "Updated plan status to: "+plan.Status)
...
func (apiCfg *apiConfig) handlerDeletePlan(w http.ResponseWriter, r *http.Request) {
	...
	apiCfg.logAudit(r, "Delete Plan", "plan", dateStr, "Deleted plan for date: "+dateStr)
